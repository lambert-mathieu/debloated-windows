...
function Show-Header {
    ...
    Write-Host "           DebloatedWindowsScript           " -ForegroundColor Yellow
    Write-Host "============================================" -ForegroundColor Cyan
    Write-Host ""
}
...
function Get-WindowsDefenderStatus {
    ...
    if ($defenderStatus -eq 4) {
        ...
        Write-Host "Note: Enabling Defender using this script means it cannot be permanently disabled again without reinstalling Windows with the DebloatedWindows XML file."
